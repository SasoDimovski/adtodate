...
$initTime = (intval(microtime(true))*1000) + (86400000 * ($i-($days/2)));
	echo '	{ "date": "'; echo $initTime; echo '", "type": "meeting", "title": "Project '; echo $i; echo ' meeting", "description": "Локација, Држава, Град, Место", "url": "http://www.event1.com/" },';
	echo '	{ "date": "'; echo $initTime+3600000; echo '", "type": "demo", "title": "Project '; echo $i; echo ' demo", "description": "Локација, Држава, Град, Место", "url": "http://www.event2.com/" },';

	echo '	{ "date": "'; echo $initTime-7200000; echo '", "type": "meeting", "title": "Test Project '; echo $i; echo ' Brainstorming", "description": "Локација, Држава, Град, Место", "url": "http://www.event3.com/" },';
