...
$sql2 = "SELECT *
FROM records
WHERE id_menu =".$_GET["mv"]."
AND publish =1 and id<>".$_GET["id"]."  AND create_date<'".$date1."'
order by
        ...
        <div class="madmen_mali">
          ...
          <?php	
	       ...
	       ?>
            ...
            <td class="slicni_slika" style="background-image:url(../../uploads/records/<?php echo $row["id"];?>/tn1_<?php echo $row["picture"];?>);background-position: center; background-size:auto 130px" onClick="window.open('record.php?mv=<?php echo $row["id_menu"];?>&id=<?php echo $row["id"];?>','_self');"></td>
            <td class="slicni_tekst"><a href="record.php?mv=<?php echo $row["id_menu"];?>&id=<?php echo $row["id"];?>"><?php echo $row["title"];?></a>
              <!--<div class="tag">Таг: 
