...
if ($create_date) {$create_date=strftime("%d %b %Y", strtotime($create_date));};
      ...
      <div class="col-md-4"> <div class="ogranicen" style="background-image:url(../../uploads/records/<?php echo $row["id"];?>/tn1_<?php echo $row["picture"];?>); height:110px; margin-top:10px" onClick="window.open('record.php?mv=<?php echo $row["id_menu"];?>&id=<?php echo $row["id"];?>','_self');"></div>
        <h3> <a href="record.php?mv=<?php echo $row["id_menu"];?>&id=<?php echo $row["id"];?>"><?php echo $row["title"];?></a></h3>
        <!--<div class="datum kat_in"><?php echo $create_date ?></a></div>
