...
if($tmpDir=="up"){
                ...
                $sql="SELECT * FROM documents WHERE pr >=".$PR1." order by pr asc LIMIT 2;";
				...
				if ($rowcount <> 0 and $rowcount >= 2)
				{
						...
						$sql = "UPDATE documents SET pr = '".$PR2."'  WHERE id=".$ID1;
						$result=mysqli_query($con, $sql);
						mysqli_free_result($result);
						
						$sql = "UPDATE documents SET pr = '".$PR1."'  WHERE id=".$ID2;
						$result=mysqli_query($con, $sql);
						mysqli_free_result($result);
				}
...
if($tmpDir=="down"){
                ...
                $sql="SELECT * FROM documents WHERE pr <= ".$PR1." order by pr desc LIMIT 2;";
                $result=mysqli_query($con, $sql);
				$rowcount=mysqli_num_rows($result);
                //die($sql);
				if ($rowcount <> 0 and $rowcount >= 2)
...
if($tmpDir=="top"){
                ...
                $sql="SELECT * FROM documents WHERE pr >=".$PR1." order by pr asc;";
                $result=mysqli_query($con, $sql);
				$rowcount=mysqli_num_rows($result);
                echo($rowcount);
				if ($rowcount <> 0 and $rowcount >= 2)
				{
                            ...
                            $result=mysqli_query($con, $sql);
									while($row = mysqli_fetch_array($result)) 
											  { 
											  $sql1 = "UPDATE documents SET pr = '".($row["pr"]-1)."'  WHERE id=".$row["id"];
											  $resul1t=mysqli_query($con, $sql1);
											  mysqli_free_result($result1);
											 }
							 $sql1 = "UPDATE documents SET pr = '".$PR2."'  WHERE id=".$ID1;
							 $resul1t=mysqli_query($con, $sql1);
							 mysqli_free_result($result1);		
...
if($tmpDir=="bottom"){
                ...
                $sql="SELECT * FROM documents WHERE pr <= ".$PR1." order by pr desc;";
                $result=mysqli_query($con, $sql);
				$rowcount=mysqli_num_rows($result);
                echo($rowcount);
				if ($rowcount <> 0 and $rowcount >= 2)
