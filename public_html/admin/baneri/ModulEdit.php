...
//=====================================================================================================================================
$sql = "Select * FROM baners WHERE id=".$tmpID;
//die($sql);
...
if (document.getElementById('id_courses_categories').value!=null){
		if (document.getElementById('id_courses_categories').value=='')
		  {alert('Field "Type" is mandatory!');return false;}
  }
//------------------------------------------------------------------------------------------------------  
//a=0;
...
?> 
               ...
               <div style="clear:both"> </div> 
                <div class="form-group">
                    ...
                    ?>
                        <div style=" float:left"><input type="checkbox" id="id_workgroups<?php echo $a?>" name="id_workgroups<?php echo $a?>" value="<?php echo $options_row["id"]?>" <?php if (in_array($options_row["id"],$allowed)){echo "checked";}?>/>
                        
                        
                        <a href="#" onClick="openPopup1('<?php echo $options_row["id"] ?>','<?php echo $tmpID ?>','<?php echo $_GET["mv"] ?>')"><?php echo $options_row["title"];?>&nbsp;&nbsp;&nbsp;</a></div>
                     ...
                     mysqli_free_result($options);
                     ?>
                  <input type="hidden" id="id_workgroups_temp" name="id_workgroups_temp" value="<?php echo $a ?>"/>
...
?> 
            <div class="form-group">
                ...
                <input name="hashtag" id="hashtag" type="text" class="form-control" placeholder="New Hashtag..." value="" maxlength="500"/>
            </div>
<?php }?>
...
<div style="clear:both"></div>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" placeholder="Edit date..."  id="editdate" name="editdate" readonly  style=" cursor:pointer" value="<?php echo $edit_date ?>"/>
        </div>
...
<div class="col-xs-6"><!--///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////-->
<img src="../img/Baner_Size_1.jpg" width="800" height="1644" alt=""/>
...
$(function() {
	...
	CKEDITOR.config.contentsCss = ['/mk/css/bootstrap.min.css', '/mk/css/adtodate.css'];
