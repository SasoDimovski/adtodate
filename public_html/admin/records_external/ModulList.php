...
$result = mysqli_query($con,"SELECT count(id) FROM records_external_links where id<>0 ".$select);
...
<td><?php  if ($row["publish"]==1) {echo "<i class=\"fa fa-check\"></i>";}else {echo "<span class=\"warning\"><i class=\"fa fa-warning\"></i> no </span>";}?></td>
