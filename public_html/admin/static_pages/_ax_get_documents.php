...
//ZAPISI STO SE PRIKAZUVAAT
		...
		SELECT documents.id, 
			   ...
			   documents.file,
			   _languages.title as _languages_title,
			   _countries.title as _countries_title, 
			   documents_categories.title as documents_categories_title  
		FROM documents 
		INNER JOIN _languages 
		ON documents.id_languages=_languages.id 
		INNER JOIN _countries 
		ON documents.id_countries=_countries.id 
		INNER JOIN documents_categories 
		ON documents.id_documents_categories=documents_categories.id 
  ...
  <div class="box-body no-padding table-responsive">
	...
	?>
      <tr>
        ...
        <td><a href="../../uploads/documents/<?php  echo $row1["id"]?>/<?php  echo $row1["file"]?>" target="_blank"><?php  echo $row1["title"]?></a></td>
        <td><?php  echo $row1["_languages_title"]?></td>
        <td><?php  echo $row1["_countries_title"]?></td>
        <td><?php  echo $row1["documents_categories_title"]?></td>
