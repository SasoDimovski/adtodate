...
$result = mysqli_query($con,"SELECT count(id) FROM galleries WHERE id<>0 ".$tmpSelect);
...
<input name="mv" id="mv" type="hidden" value="<?php  echo $_GET["mv"]?>" /> 
            ...
            <div class="row">
             ...
             <div class="col-xs-2">
                <input class="form-control input-sm" name="search1" id="search1" type="text" value="<?php  echo $_GET["search1"]?>" placeholder="search by Title" maxlength="100"/>
             </div>
...
<tr>
    ...
    <td><a class="btn btn-primary btn-xs" href="../galleries_uploadifive/ModulEdit.php?<?php echo $query?>&id=<?php echo $row["id"]?>"><i class="fa fa-edit"></i> add pictures</a></td>
